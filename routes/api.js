...
try {
var zahirr = db.get("zakygans");
} catch (e) {
	console.log('')
}

var creatorList = ['@zganz','@zaky','@zganz404','@zakky', '@zakyganteng','@zganzganteng','@zganz404ganz'];
...
var len = 15
        ...
        var randomTextNumber = random+randomlagi+'---------ZakyGanteng'+'ZAKY--GANS';
...
router.get('/find', async (req, res, next) => {
    ...
    if (apikey != 'uc02828jkakndhsisbsisbdidbaodbfiej8882728jbfjsn') return res.json(loghandler.invalidKey)
